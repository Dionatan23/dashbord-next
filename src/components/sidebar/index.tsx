...
export function Sidebar() {
  return (
    <div className="flex w-full flex-col bg-muted/40">
      <aside className="fixed inset-y-0 left-0 z-10 w-14 hidden border-r bg-background sm:flex flex-col">
      ...
      <div className="sm:hidden flex flex-col sm:gap-4 sm:pl-14">
        <header
          className="sticky top-0 z-30 flex h-14 px-4 items-center border-b 
        ...
        >
          <Sheet>
            ...
            <SheetContent side="top" className="sm:max-w-x bg-white">
